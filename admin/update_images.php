...
if(isset($_POST['update_images'])) {
    ...
    if ($stmt->execute()){
        header('Location: admin_products.php?images_updated=Images have been updated successfully');
    }else{
        header('Location: admin_products.php?images_failed=Error occurred. Try again.');
    }
}
